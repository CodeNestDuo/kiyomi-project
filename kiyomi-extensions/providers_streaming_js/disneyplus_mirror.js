...
// @type          streaming
// @description   Disney Plus Mirror with replicated Recursive POST Bypass.
// ==/KiyomiExtension==
...
function search(query, page) {
    ...
    // We only need to run the bypass on the first search or page 1
    if (page === 1) {
        runBypass();
    }
